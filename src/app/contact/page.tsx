      ...
      <footer className="site-footer">
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              <h5>Get in Touch</h5>
              <a href="mailto:robinjones@gmail.com">robinjones@gmail.com</a>
              <a href="https://www.linkedin.com/in/robintjones/" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a>
              <a href="https://www.facebook.com/wubledoo" target="_blank" rel="noopener noreferrer">Follow on Facebook</a>
          ...
          <div className="footer-bottom">
            ...
            <div className="socials">
              <a aria-label="LinkedIn" href="https://www.linkedin.com/in/robintjones/" target="_blank" rel="noopener noreferrer"><svg aria-hidden="true" className="icon-linkedin" fill="currentColor" viewBox="0 0 24 24"><path d="M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.86 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.46v6.28ZM5.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12ZM7.12 20.45H3.56V9h3.56v11.45Z"></path></svg></a>
              <a aria-label="Facebook" href="https://www.facebook.com/wubledoo" target="_blank" rel="noopener noreferrer"><svg aria-hidden="true" fill="currentColor" viewBox="0 0 24 24" style={{ width: 20, height: 20 }}><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg></a>
              <a aria-label="Email" href="mailto:robinjones@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg></a>
            </div>
          </div>
        </div>
      </footer>
