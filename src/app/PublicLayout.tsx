      ...
      <nav className={"nav" + (navOpen ? " menu-open" : "")}>
        <div className="nav-row">
          ...
          <div className={navClass}>
            ...
            <Link className={(activeOverride === 'experience' || (!activeOverride && pathname.startsWith('/experience'))) ? 'active' : ''} href="/experience" onClick={() => setNavOpen(false)}>Experience &amp; Impact</Link>
        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <Link href="/experience">Experience &amp; Impact</Link>
            ...
            <div className="footer-col">
              <h5>Get in Touch</h5>
              <Link href="mailto:robinj@stanfordalumni.org">robinj@stanfordalumni.org</Link>
          ...
          <div className="footer-bottom">
            <span>© <span className="year" suppressHydrationWarning></span> Robin Jones. All rights reserved.</span>
            <div className="socials">
              ...
              <Link aria-label="Email" href="mailto:robinj@stanfordalumni.org"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg></Link>
            </div>
          </div>
        </div>
      </footer>
