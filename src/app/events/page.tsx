...
export default async function Page() { const globalForPrisma = globalThis as unknown as { prisma: any }; const prisma = globalForPrisma.prisma || new (require("@prisma/client").PrismaClient)(); const initialEvents = await prisma.event.findMany({ where: { status: { in: ["Published", "Completed"] } }, orderBy: { date: "asc" } });
return (<><PublicNav />
<div>
        {/*  ===================== HERO =====================  */}
        <div className="hero">
